 ...
 * Slug: travel-manager/footer-default
 * Categories: footer
...
<p class="has-text-align-right has-link-color">
	...
	printf(
		...
		esc_html__( 'Proudly powered by %s', 'travel-manager' ),
		'<a href="' . esc_url( __( 'https://wordpress.org', 'travel-manager' ) ) . '" rel="nofollow">WordPress</a>'
	)
	?>
</p>
<!-- /wp:paragraph --></div>
