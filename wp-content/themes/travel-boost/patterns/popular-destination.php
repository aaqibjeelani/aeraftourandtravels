 ...
 * Slug: featured/popular-destination
 * Categories: featured
 */
?>
...
<h3 class="wp-block-heading has-text-align-center">T<?php echo esc_html__( 'ravel Inspiration', 'travel-boost' ); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:post-title {"textAlign":"left","level":3,"isLink":true,"style":{"spacing":{"padding":{"right":"var:preset|spacing|30","left":"var:preset|spacing|30"}}},"fontSize":"medium"} /--></div>
<!-- /wp:group -->
