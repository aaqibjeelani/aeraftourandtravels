...
class Travel_Boost_Admin_Info {
    ...
    public function add_menu() {
        add_theme_page(
            esc_html__('Travel Boost Theme', 'travel-boost'),
            esc_html__('Travel Boost Theme', 'travel-boost'),
            'edit_theme_options',
            'travel-boost',
    ...
    public function check_rt_easy_builder_freemius() {
        ...
        // Add your actions
            ...
            add_action( 'wp_ajax_dismiss_travel_boost_notification', array( $this, 'dismiss_notification_ajax_handler' ) );
        }
    }
    ...
    public function reset_notification_dismissal() {
        delete_transient('travel_boost_notification_dismissed');
    }
    ...
    public function compatible_check() {
        ...
        $dismissed = get_transient('travel_boost_notification_dismissed');
        if ($dismissed !== '1') {
    ...
    public function dismiss_notification() {
        ...
        set_transient('travel_boost_notification_dismissed', '1', 7 * DAY_IN_SECONDS);
    }
            ...
            (function($) {
                $(document).on('click', '.notice.is-dismissible .notice-dismiss', function() {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {
                            action: 'dismiss_travel_boost_notification',
...
// Instantiate the Travel Boost Admin Info class
new Travel_Boost_Admin_Info();
